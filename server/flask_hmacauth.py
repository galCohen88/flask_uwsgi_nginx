...
https://github.com/Phillipmartin/flask-hmacauth/blob/master/flask_hmacauth.py
watch this:
https://www.youtube.com/watch?v=WuhVU9F3flU
"""
import hmac
...
class HmacManager(object):
    ...
    def is_authorized(self, request_obj, required_rights):
        ...
        if ts < datetime.datetime.now()-datetime.timedelta(seconds=60) \
